...
public class CharacterStats : MonoBehaviour
{
    ...
    void Update()
    {
        if (!updateOnce)
        {
            ...
            m_playerXP.text = m_playerRef.GetComponent<PlayerAttributes>().currentXP + "/";
            ...
            m_playerXPLimit.text = PlayerAttributes.levelUpInfo[PlayerAttributes.currentLevel - 1].xpTillNextLevel.ToString();
        }
    }
}
